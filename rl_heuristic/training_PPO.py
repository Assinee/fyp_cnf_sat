...
checkpoint_callback = CheckpointCallback(save_freq=1000000, save_path='./agents/agents_ppo_20_3_9_10_100_1000000',
                                         name_prefix='rl_agent')
# Evaluation callback to evaluate the model and save the best one
eval_callback = EvalCallback(eval_env, best_model_save_path='./agents/agents_ppo_20_3_9_10_100_1000000/best_model/',
                             log_path='./logs/logs_ppo_20_3_9_10_100_1000000/', eval_freq=5000,
...
best_model = PPO.load("./agents/agents_ppo_20_3_9_10_100_1000000/best_model/best_model")
best_model.save("final_model/final_model_ppo_20_3_9_10_100_1000000")