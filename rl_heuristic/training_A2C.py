...
checkpoint_callback = CheckpointCallback(save_freq=1000000, save_path='./agents/agents_a2c_3_1_9_10_1000000_NEW',
                                         name_prefix='rl_agent')
# Evaluation callback to evaluate the model and save the best one
eval_callback = EvalCallback(eval_env, best_model_save_path='./agents/agents_a2c_3_1_9_10_1000000_NEW/best_model/',
                             log_path='./logs/logs_a2c_3_1_9_10_1000000_NEW/', eval_freq=5000,
...
best_model = A2C.load("./agents/agents_a2c_3_1_9_10_1000000_NEW/best_model/best_model")
best_model.save("final_model/final_model_a2c_3_1_9_10_1000000_NEW")
